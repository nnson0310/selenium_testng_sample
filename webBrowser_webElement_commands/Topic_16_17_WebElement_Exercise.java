...
public class Topic_16_17_WebElement_Exercise {
	...
	public void beforeMethod() {
		...
		link = driver.findElement(By.xpath("//div[@class='footer']//a[text()='My Account']"));
	}
	...
	public void TC_04() {
		...
		Assert.assertEquals(driver
				.findElement(By.xpath("//li[@class='error-msg']//span[text()='Invalid login or password.']")).getText(),
...
//		Assert.assertEquals(info[1], randomEmail + "@gmail.com");
		...
		Assert.assertTrue(driver.findElement(By.xpath("//a[text()='Change Password']//parent::p")).getText().contains("Nguyen Thu Hang"));
		Assert.assertTrue(driver.findElement(By.xpath("//a[text()='Change Password']//parent::p")).getText().contains(randomEmail + "@gmail.com"));
...
//		Assert.assertEquals(title, "Home page");
	...
	public void TC_06() {
		...
		Assert.assertTrue(driver.findElement(By.xpath("//a[text()='Change Password']//parent::p")).getText().contains("Nguyen Thu Hang"));
		Assert.assertTrue(driver.findElement(By.xpath("//a[text()='Change Password']//parent::p")).getText().contains("thuhang@gmail.com"));
	}
